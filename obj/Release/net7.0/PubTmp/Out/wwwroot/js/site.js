    ...
    success: function (chData) {
        ...
        var dataT = {
            ...
            datasets: [{
                ...
                data: aDatasets1,
                fill: false,
                backgroundColor: ["rgba(54, 162, 235, 0.9)", "rgba(255, 99, 132, 0.9)", "rgba(255, 159, 64, 0.9)", "rgba(255, 205, 86, 0.9)", "rgba(75, 192, 192, 0.9)", "rgba(153, 102, 255, 0.9)", "rgba(201, 203, 207, 0.9)"],
        ...
        var myNewChart = new Chart(ctx, {
            ...
            options: {
                ...
                scales: {
                    ...
                    yAxes: [{ gridLines: { display: false }, display: true, scaleLabel: { display: false, labelString: '' }, ticks: { stepSize: 10000, beginAtZero: true } }]
                },
            }
        });
    }
...
function showPosition(position) {
    ...
    navigator.geolocation.getCurrentPosition(function (position) {
        ...
        var nominatimUrl = 'https://nominatim.openstreetmap.org/reverse?format=json&lat=' + userLat + '&lon=' + userLng;
        fetch(nominatimUrl)
